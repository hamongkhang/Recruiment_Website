...
<div class="container-fluid published-recuitment-wrapper">
  <div class="container published-recuitment-content">
    <div class="row">
      ...
      <form class="recuitment-form" method="POST" action="?c=Job&a=RequestCreate" id="registration" enctype="multipart/form-data">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body recuitment-body">
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="Nhập tiêu đề" name="Position">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-3 col-form-label text-right label">Email ứng tuyển<span style="color: red" class="pl-2">*</span></label>
          <div class="col-sm-9">
            <input type="email" class="form-control" placeholder="techjob@gmail.com" name="ApplicationEmail">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="number" class="form-control" placeholder="1" name="Amount">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-3 col-form-label text-right label">Mô tả công việc<span style="color: red" class="pl-2">*</span></label>
          <div class="col-sm-9">
            <textarea type="text" class="form-control" id="content" placeholder="Nhập mô tả công việc" rows="5" name="Details"></textarea>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9 d-flex">
            <input type="number" class="form-control" placeholder="Lương Khoảng Từ" name="SalaryMin"> <label class="m-1"></label>
            <input type="number" class="form-control" placeholder="Đến" name="SalaryMax"> <label class="m-1"></label>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="number" class="form-control" placeholder="8" name="WorkTime">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-3 col-form-label text-right label">Ngành nghề</label>
          <div class="col-sm-9">
            <select type="text" multiple id="multiCareers" name="Careers[]">
            <?php
            ...
            <a href="#" data-toggle="modal" data-target="#createCareers">Thêm mới ngành nghề</a>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="Address" placeholder="Nhập địa chỉ làm việc">
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-3 col-form-label text-right label">Hạn nộp hồ sơ<span style="color: red" class="pl-2">*</span></label>
          <div class="col-sm-9">
            <input type="date" class="form-control" placeholder="Nhập nơi làm việc" name="Deadline">
          </div>
        </div>
