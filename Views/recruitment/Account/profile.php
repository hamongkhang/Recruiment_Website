    ...
    <div class="row">
      <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
        <div class="recuitment-form">
            <h3 class="rect-heading">Hồ sơ nhà tuyển dụng</h3>
    ...
    <!-- <form class="" method="post" id="frm-info" novalidate="novalidate"> -->
      <div class="row rowdiv">
        <div class="col-md-3 col-xs-12">
          <div class="row">
          <form action="?c=User&a=RecUpdateAvatar" method="POST" enctype="multipart/form-data">
          <input type="hidden" value="<?= $user2[0] ?>" name="id" />
            <div id="ImgPreview" class="img">
              <img id="blah" src="Assets/upload/user_avatar/<?= $user2[11] ?>">
              <input type="file" name="UserAvatar" id="imgInp" class="custom-fileinput">
      ...
      <!-- quản lý công ty  -->
      <h2 class="user--profile-title-group">Thông tin công ty
    </h2>
    <!-- <form class="" method="post" id="frm-info" novalidate="novalidate"> -->
      <div class="row rowdiv">
        <div class="col-md-3 col-xs-12">
          <div class="row">
          <form action="?c=User&a=RecUpdateLogo" method="POST" enctype="multipart/form-data">
          <input type="hidden" value="<?= $user2[13] ?>" name="id" />
          <input type="hidden" value="<?= $user2[0] ?>" name="uid" />
            <div id="ImgPreview" class="img">
            <div class="img2div">
            <img id="blah2" src="Assets/upload/company_image/<?= $user2[16] ?>">
            </div>
              
              <input type="file" name="CompanyLogo" id="imgInp2" class="custom-fileinput">
              <label class="lbcfip">Chọn logo...</label>
              <input type="submit" id="sbAvatar2" value="✓" style="display: none;">
            </div>
            </form>
          </div>
        ...
        <div class="col-md-8 col-xs-12">
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="FamilyName" class="required" aria-required="true">Tên công ty
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-name" class="span-display" style="display: block;"><?= $user2[14] ?>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="BirthYear">Quy mô công ty
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-birthday" class="span-display" style="display: block;"><?= $user2[20] ?>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="text" class="required" aria-required="true">Người đại diện
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-phone" class="span-display" style="display: block;"><?= $user2[22] ?>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="EmailAddress" class="required" aria-required="true">Website
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-email" class="span-display" style="display: block;"><?= $user2[19] ?>
                </span>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="EmailAddress" class="required" aria-required="true">Tỉnh/Thành phố
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-email" class="span-display" style="display: block;"><?= $user2[18] ?>
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-sm-4 col-xs-12">
              <div class="form-group">
                <label for="EmailAddress" class="required" aria-required="true">Sơ lược công ty
                </label>
              </div>
            </div>
            <div class="col-lg-8 col-sm-8 col-xs-12">
              <div class="form-group">
                <span id="span-email" class="span-display" style="display: block;"><?= $user2[15] ?>
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-1">
          <p style="float: right;">
            <a href="javascript:void(0)" data-toggle="modal" data-target="#infoCompany">
              <i class="fa fa-edit" id="edit-pencil-info">
              </i>
            </a>
          </p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="?c=User&a=UpdateReProfile" method="POST">
...
<div class="modal fade" id="addExperience" tabindex="-1" role="dialog" aria-labelledby="addExperience" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="?c=User&a=AddUserExperience" method="POST">
        <input type="hidden" name="id" value="<?= $user2[0] ?>"/>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
...
<div class="modal fade" id="addSkill" tabindex="-1" role="dialog" aria-labelledby="addSkill" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="?c=User&a=AddUserSkill" method="POST">
        <input type="hidden" name="id" value="<?= $user2[0] ?>"/>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
