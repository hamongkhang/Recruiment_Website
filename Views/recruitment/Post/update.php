    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-12 recuitment-inner">
        <div class="recuitment-form">
            <h3 class="rect-heading">Chỉnh sửa bài viết</h3>
            <form action="?c=Post&a=RequestUpdate" method="POST" id="registration" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group input-file-container">
                            ...
                            <div class="thumb_before" style="display:none">
                                <input type="hidden" name="Thumbnail" id="file" class="input-file" />
                                <label tabindex="0" for="my-file" class="input-file-trigger">Chọn ảnh bài viết...</label>
                                <p class="file-return"></p>
                            </div>
                            <div class="thumb_live">
                                <img src="Assets/upload/post_thumb/<?=$post[3]?>" alt="" style="width: 100%"/>
                                <a href="#" id="chImg">Đổi ảnh</a>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function(){
        $("#chImg").click(function () {
            $(".thumb_before").attr("style", "display:block");
            $(".thumb_live").attr("style", "display:none");
            $("#file").attr("type", "file");
        });
});
    </script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.js"></script>
    <!-- query upload in edit   -->
