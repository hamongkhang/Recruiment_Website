...
<div class="container-fluid">
  <div class="container search-wrapper">
                                ...
                                <div class="filter-panel">
                                    <div class="panel-content">
                                        <div class="filter-topic filter-input-price">
                                            <form class="al-price-filter" action="?c=Job&a=Filter_PriceRange" method="POST">
                                                <span class="_fpblock">
                                                    <input type="number" name="PriceMin" class="if-price" id="" placeholder="50,000">
                                                </span>
                                                <span class="_fpblock _line">
                                                    <p>-</p>
                                                </span>
                                                <span class="_fpblock">
                                                    <input type="number" name="PriceMax" class="if-price" id="" placeholder="1,000,000">
                                                </span>
                                                 <span class="_fpblock">
    ...
    <div class="col-md-9 col-sm-12 col-12">
      <h4 class="search-find"><?php if(isset($q)) echo "Hiển thị bài viết theo từ khóa: ".$q; else echo "Tất cả bài viết";?></h4>
            ...
            <div class="job pagi">
              <div class="job-content">
                ...
                <div class="wrap-btn-appl">
                  <a href="?c=Job&a=SavedJob&job=<?=$tPost[0]?>&uid=<?=$user_id[0]?>" class="btn btn-appl"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
            <?php } ?>
